...
//Yahoo download service where you can fetch quote information from Yahoo in .csv format, with a 20 minute delay
   ...
   // private static final Log log = LogFactory.getLog(StockTickerDAO.class);
    ...
    private synchronized StockBean refreshStockInfo(String symbol, long time) {
        try {
        	...
        	Logger.getLogger("Unable to get stockinfo for: " + symbol + ex);
        }
